...
- [Cranmera](https://rosemanlabs.com/) - Commercial-grade MPC engine and sdk with emphasis on performance and scalability. SPDZ and SPDZ-2^k-based ≥2PC and BGW/Shamir-based ≥3PC secure against semi-honest adversaries, augmented with higher-order protocols like zero tests, comparisons, share conversions, and secure linear algebra and machine learning primitives.
