...
- [SecretFlow](https://github.com/secretflow) - 2PC/3PC with secret sharing; secure against semi-honest adversary; focused on building a unified framework for privacy-preserving data analysis and machine learning.
