...
- [cb-mpc](https://github.com/coinbase/cb-mpc) - Production-grade MPC library for threshold ECDSA and EdDSA signing, HD key derivation, DKG, and secure backup; written in C++ with Go bindings. | [blog](https://www.coinbase.com/blog/introducing-coinbases-open-source-mpc-cryptography-library).
...
- [mpc4j](https://github.com/alibaba-edu/mpc4j) - Comprehensive Java library for MPC, HE, and DP with state-of-the-art implementations of PSI, PIR, VOLE, OPRF, and secret sharing protocols; focused on academic benchmarking. | [USENIX Security'23](https://www.usenix.org/conference/usenixsecurity23/presentation/zhang-cong).
...
- [multi-party-sig](https://github.com/taurushq-io/multi-party-sig) - Go implementation of CGGMP threshold ECDSA with identifiable aborts, FROST threshold Schnorr (Taproot-compatible), and BIP-32 key derivation. | eprint: [2021/060](https://eprint.iacr.org/2021/060).
...
- [Secrecy](https://github.com/CASP-Systems-BU/Secrecy) - Relational MPC framework for collaborative analytics on secret-shared data; 3PC with replicated secret sharing; secure against semi-honest adversaries. | [NSDI'23](https://www.usenix.org/conference/nsdi23/presentation/liagouris).
...
- [TVA](https://github.com/CASP-Systems-BU/tva) - MPC system for secure and expressive time series analytics; 3PC with replicated and Shamir secret sharing; secure against semi-honest and malicious adversaries.
...
- [YACL](https://github.com/secretflow/yacl) - C++ cryptographic library implementing OT (IKNP, KOS, KKRT, Ferret, SoftSpoken), VOLE (Silent, Wolverine), DPF, PRG, random oracle, and some other MPC primitives. | [algorithms](https://github.com/secretflow/yacl/blob/main/ALGORITHMS.md).
...
- [secure-join](https://github.com/Visa-Research/secure-join) - Oblivious two-party database joins on secret-shared tables with permutation and Alternating Moduli PRF protocols. | eprint: [2024/547](https://eprint.iacr.org/2024/547), [2024/582](https://eprint.iacr.org/2024/582).
- [VOLE-PSI](https://github.com/Visa-Research/volepsi) - Fast Private Set Intersection and Circuit-PSI based on Vector-OLE and improved OKVS; cross-platform. | eprint: [2021/266](https://eprint.iacr.org/2021/266), [2023/903](https://eprint.iacr.org/2023/903).
